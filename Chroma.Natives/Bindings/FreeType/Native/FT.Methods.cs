...
using NativeLibrary = Chroma.Natives.Boot.NativeLibrary;

namespace Chroma.Natives.Bindings.FreeType.Native
{
    internal static unsafe partial class FT
    {
        private static NativeLibrary FTL =
            ModuleInitializer.Platform.Registry.TryRetrieve(
                true, 
                "libfreetype.so",
                "freetype.dll",
                "libfreetype.dylib"
        ...
        public static __FT_Library_Version FT_Library_Version =
            FTL.LoadFunction<__FT_Library_Version>("FT_Library_Version");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U1)]
        public delegate bool __FT_Face_CheckTrueTypePatents(IntPtr face);

        public static __FT_Face_CheckTrueTypePatents FT_Face_CheckTrueTypePatents =
            FTL.LoadFunction<__FT_Face_CheckTrueTypePatents>("FT_Face_CheckTrueTypePatents");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.U1)]
        public delegate bool __FT_Face_SetUnpatentedHinting(IntPtr face, [MarshalAs(UnmanagedType.U1)] bool value);

        public static __FT_Face_SetUnpatentedHinting FT_Face_SetUnpatentedHinting =
            FTL.LoadFunction<__FT_Face_SetUnpatentedHinting>("FT_Face_SetUnpatentedHinting");
        ...
        public static __FT_Reference_Face
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Set_Char_Size(IntPtr face, IntPtr char_width, IntPtr char_height,
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error
            __FT_Get_Track_Kerning(IntPtr face, IntPtr point_size, int degree, out IntPtr akerning);

        public static __FT_Get_Track_Kerning FT_Get_Track_Kerning =
            FTL.LoadFunction<__FT_Get_Track_Kerning>("FT_Get_Track_Kerning");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Get_Glyph_Name(IntPtr face, uint glyph_index, IntPtr buffer, uint buffer_max);

        public static __FT_Get_Glyph_Name
            FT_Get_Glyph_Name = FTL.LoadFunction<__FT_Get_Glyph_Name>("FT_Get_Glyph_Name");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr __FT_Get_Postscript_Name(IntPtr face);

        public static __FT_Get_Postscript_Name FT_Get_Postscript_Name =
            FTL.LoadFunction<__FT_Get_Postscript_Name>("FT_Get_Postscript_Name");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Select_Charmap(IntPtr face, FT_Encoding encoding);

        public static __FT_Select_Charmap
            FT_Select_Charmap = FTL.LoadFunction<__FT_Select_Charmap>("FT_Select_Charmap");
        ...
        public static __FT_Get_Charmap_Index FT_Get_Charmap_Index =
        ...
        public static __FT_Get_First_Char
            FT_Get_First_Char = FTL.LoadFunction<__FT_Get_First_Char>("FT_Get_First_Char");
        ...
        public static __FT_Get_Name_Index
            FT_Get_Name_Index = FTL.LoadFunction<__FT_Get_Name_Index>("FT_Get_Name_Index");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Get_SubGlyph_Info(IntPtr glyph, uint sub_index, out int p_index, out uint p_flags,
            out int p_arg1, out int p_arg2, out FT_Matrix p_transform);

        public static __FT_Get_SubGlyph_Info FT_Get_SubGlyph_Info =
            FTL.LoadFunction<__FT_Get_SubGlyph_Info>("FT_Get_SubGlyph_Info");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate ushort __FT_Get_FSType_Flags(IntPtr face);

        public static __FT_Get_FSType_Flags FT_Get_FSType_Flags =
            FTL.LoadFunction<__FT_Get_FSType_Flags>("FT_Get_FSType_Flags");
        ...
        public static __FT_Face_GetCharVariantIndex FT_Face_GetCharVariantIndex =
            FTL.LoadFunction<__FT_Face_GetCharVariantIndex>("FT_Face_GetCharVariantIndex");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __FT_Face_GetCharVariantIsDefault(IntPtr face, uint charcode, uint variantSelector);

        public static __FT_Face_GetCharVariantIsDefault FT_Face_GetCharVariantIsDefault =
            FTL.LoadFunction<__FT_Face_GetCharVariantIsDefault>("FT_Face_GetCharVariantIsDefault");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr __FT_Face_GetVariantSelectors(IntPtr face);

        public static __FT_Face_GetVariantSelectors FT_Face_GetVariantSelectors =
            FTL.LoadFunction<__FT_Face_GetVariantSelectors>("FT_Face_GetVariantSelectors");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr __FT_Face_GetVariantsOfChar(IntPtr face, uint charcode);

        public static __FT_Face_GetVariantsOfChar FT_Face_GetVariantsOfChar =
            FTL.LoadFunction<__FT_Face_GetVariantsOfChar>("FT_Face_GetVariantsOfChar");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr __FT_Face_GetCharsOfVariant(IntPtr face, uint variantSelector);

        public static __FT_Face_GetCharsOfVariant FT_Face_GetCharsOfVariant =
            FTL.LoadFunction<__FT_Face_GetCharsOfVariant>("FT_Face_GetCharsOfVariant");
        ...
        public static __FT_Glyph_Transform FT_Glyph_Transform =
            FTL.LoadFunction<__FT_Glyph_Transform>("FT_Glyph_Transform");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Glyph_Get_CBox(IntPtr glyph, FT_Glyph_BBox_Mode bbox_mode, out FT_BBox acbox);

        public static __FT_Glyph_Get_CBox
            FT_Glyph_Get_CBox = FTL.LoadFunction<__FT_Glyph_Get_CBox>("FT_Glyph_Get_CBox");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Glyph_To_Bitmap(ref IntPtr the_glyph, FT_Render_Mode render_mode,
            ref FT_Vector origin, [MarshalAs(UnmanagedType.U1)] bool destroy);

        public static __FT_Glyph_To_Bitmap FT_Glyph_To_Bitmap =
            FTL.LoadFunction<__FT_Glyph_To_Bitmap>("FT_Glyph_To_Bitmap");
        ...
        public static __FT_New_Face_From_FOND FT_New_Face_From_FOND =
            FTL.LoadFunction<__FT_New_Face_From_FOND>("FT_New_Face_From_FOND");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
            ThrowOnUnmappableChar = true)]
        public delegate FT_Error __FT_GetFile_From_Mac_Name(string fontName, out IntPtr pathSpec, out int face_index);

        public static __FT_GetFile_From_Mac_Name FT_GetFile_From_Mac_Name =
            FTL.LoadFunction<__FT_GetFile_From_Mac_Name>("FT_GetFile_From_Mac_Name");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
            ThrowOnUnmappableChar = true)]
        public delegate FT_Error __FT_GetFile_From_Mac_ATS_Name(string fontName, out IntPtr pathSpec,
            out int face_index);

        public static __FT_GetFile_From_Mac_ATS_Name FT_GetFile_From_Mac_ATS_Name =
            FTL.LoadFunction<__FT_GetFile_From_Mac_ATS_Name>("FT_GetFile_From_Mac_ATS_Name");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
            ThrowOnUnmappableChar = true)]
        public delegate FT_Error __FT_GetFilePath_From_Mac_ATS_Name(string fontName, IntPtr path, int maxPathSize,
            out int face_index);

        public static __FT_GetFilePath_From_Mac_ATS_Name FT_GetFilePath_From_Mac_ATS_Name =
            FTL.LoadFunction<__FT_GetFilePath_From_Mac_ATS_Name>("FT_GetFilePath_From_Mac_ATS_Name");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_New_Face_From_FSSpec(IntPtr library, IntPtr spec, int face_index,
            out IntPtr aface);

        public static __FT_New_Face_From_FSSpec FT_New_Face_From_FSSpec =
            FTL.LoadFunction<__FT_New_Face_From_FSSpec>("FT_New_Face_From_FSSpec");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error
            __FT_New_Face_From_FSRef(IntPtr library, IntPtr @ref, int face_index, out IntPtr aface);

        public static __FT_New_Face_From_FSRef FT_New_Face_From_FSRef =
            FTL.LoadFunction<__FT_New_Face_From_FSRef>("FT_New_Face_From_FSRef");
        ...
        public static __FT_Vector_Transform FT_Vector_Transform =
            FTL.LoadFunction<__FT_Vector_Transform>("FT_Vector_Transform");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Matrix_Multiply(ref FT_Matrix a, ref FT_Matrix b);

        public static __FT_Matrix_Multiply FT_Matrix_Multiply =
            FTL.LoadFunction<__FT_Matrix_Multiply>("FT_Matrix_Multiply");
        ...
        public static __FT_Vector_Polarize FT_Vector_Polarize =
            FTL.LoadFunction<__FT_Vector_Polarize>("FT_Vector_Polarize");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Vector_From_Polar(out FT_Vector vec, IntPtr length, IntPtr angle);

        public static __FT_Vector_From_Polar FT_Vector_From_Polar =
            FTL.LoadFunction<__FT_Vector_From_Polar>("FT_Vector_From_Polar");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_New(IntPtr library, uint numPoints, int numContours,
            out IntPtr anoutline);

        public static __FT_Outline_New FT_Outline_New = FTL.LoadFunction<__FT_Outline_New>("FT_Outline_New");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_New_Internal(IntPtr memory, uint numPoints, int numContours,
            out IntPtr anoutline);

        public static __FT_Outline_New_Internal FT_Outline_New_Internal =
            FTL.LoadFunction<__FT_Outline_New_Internal>("FT_Outline_New_Internal");
        ...
        public static __FT_Outline_Done_Internal FT_Outline_Done_Internal =
            FTL.LoadFunction<__FT_Outline_Done_Internal>("FT_Outline_Done_Internal");
        ...
        public static __FT_Outline_Translate FT_Outline_Translate =
            FTL.LoadFunction<__FT_Outline_Translate>("FT_Outline_Translate");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Outline_Transform(IntPtr outline, ref FT_Matrix matrix);

        public static __FT_Outline_Transform FT_Outline_Transform =
            FTL.LoadFunction<__FT_Outline_Transform>("FT_Outline_Transform");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_Embolden(IntPtr outline, IntPtr strength);

        public static __FT_Outline_Embolden FT_Outline_Embolden =
            FTL.LoadFunction<__FT_Outline_Embolden>("FT_Outline_Embolden");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_EmboldenXY(IntPtr outline, int xstrength, int ystrength);

        public static __FT_Outline_EmboldenXY FT_Outline_EmboldenXY =
            FTL.LoadFunction<__FT_Outline_EmboldenXY>("FT_Outline_EmboldenXY");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Outline_Reverse(IntPtr outline);

        public static __FT_Outline_Reverse FT_Outline_Reverse =
            FTL.LoadFunction<__FT_Outline_Reverse>("FT_Outline_Reverse");
        ...
        public static __FT_Outline_Get_BBox FT_Outline_Get_BBox =
            FTL.LoadFunction<__FT_Outline_Get_BBox>("FT_Outline_Get_BBox");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_Decompose(IntPtr outline, ref FT_Outline_Funcs func_interface,
            IntPtr user);

        public static __FT_Outline_Decompose FT_Outline_Decompose =
            FTL.LoadFunction<__FT_Outline_Decompose>("FT_Outline_Decompose");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Outline_Get_CBox(IntPtr outline, out FT_BBox acbox);

        public static __FT_Outline_Get_CBox FT_Outline_Get_CBox =
            FTL.LoadFunction<__FT_Outline_Get_CBox>("FT_Outline_Get_CBox");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_Get_Bitmap(IntPtr library, IntPtr outline, IntPtr abitmap);

        public static __FT_Outline_Get_Bitmap FT_Outline_Get_Bitmap =
            FTL.LoadFunction<__FT_Outline_Get_Bitmap>("FT_Outline_Get_Bitmap");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Outline_Render(IntPtr library, IntPtr outline, IntPtr @params);

        public static __FT_Outline_Render
            FT_Outline_Render = FTL.LoadFunction<__FT_Outline_Render>("FT_Outline_Render");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Orientation __FT_Outline_Get_Orientation(IntPtr outline);

        public static __FT_Outline_Get_Orientation FT_Outline_Get_Orientation =
            FTL.LoadFunction<__FT_Outline_Get_Orientation>("FT_Outline_Get_Orientation");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Get_Advances(IntPtr face, uint start, uint count, uint load_flags,
            out IntPtr padvance);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error
            __FT_Bitmap_Embolden(IntPtr library, IntPtr bitmap, IntPtr xStrength, IntPtr yStrength);

        public static __FT_Bitmap_Embolden FT_Bitmap_Embolden =
            FTL.LoadFunction<__FT_Bitmap_Embolden>("FT_Bitmap_Embolden");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Bitmap_Convert(IntPtr library, IntPtr source, IntPtr target, int alignment);

        public static __FT_Bitmap_Convert
            FT_Bitmap_Convert = FTL.LoadFunction<__FT_Bitmap_Convert>("FT_Bitmap_Convert");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_GlyphSlot_Own_Bitmap(IntPtr slot);

        public static __FT_GlyphSlot_Own_Bitmap FT_GlyphSlot_Own_Bitmap =
            FTL.LoadFunction<__FT_GlyphSlot_Own_Bitmap>("FT_GlyphSlot_Own_Bitmap");
        ...
        public static __FT_Outline_GetInsideBorder FT_Outline_GetInsideBorder =
            FTL.LoadFunction<__FT_Outline_GetInsideBorder>("FT_Outline_GetInsideBorder");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_StrokerBorder __FT_Outline_GetOutsideBorder(IntPtr outline);

        public static __FT_Outline_GetOutsideBorder FT_Outline_GetOutsideBorder =
            FTL.LoadFunction<__FT_Outline_GetOutsideBorder>("FT_Outline_GetOutsideBorder");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Stroker_Set(IntPtr stroker, int radius, FT_Stroker_LineCap line_cap,
            FT_Stroker_LineJoin line_join, IntPtr miter_limit);
        ...
        public static __FT_Stroker_Rewind
            FT_Stroker_Rewind = FTL.LoadFunction<__FT_Stroker_Rewind>("FT_Stroker_Rewind");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_ParseOutline(IntPtr stroker, IntPtr outline,
            [MarshalAs(UnmanagedType.U1)] bool opened);

        public static __FT_Stroker_ParseOutline FT_Stroker_ParseOutline =
            FTL.LoadFunction<__FT_Stroker_ParseOutline>("FT_Stroker_ParseOutline");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_BeginSubPath(IntPtr stroker, ref FT_Vector to,
            [MarshalAs(UnmanagedType.U1)] bool open);

        public static __FT_Stroker_BeginSubPath FT_Stroker_BeginSubPath =
            FTL.LoadFunction<__FT_Stroker_BeginSubPath>("FT_Stroker_BeginSubPath");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_EndSubPath(IntPtr stroker);

        public static __FT_Stroker_EndSubPath FT_Stroker_EndSubPath =
            FTL.LoadFunction<__FT_Stroker_EndSubPath>("FT_Stroker_EndSubPath");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_LineTo(IntPtr stroker, ref FT_Vector to);

        public static __FT_Stroker_LineTo
            FT_Stroker_LineTo = FTL.LoadFunction<__FT_Stroker_LineTo>("FT_Stroker_LineTo");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_ConicTo(IntPtr stroker, ref FT_Vector control, ref FT_Vector to);

        public static __FT_Stroker_ConicTo FT_Stroker_ConicTo =
            FTL.LoadFunction<__FT_Stroker_ConicTo>("FT_Stroker_ConicTo");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_CubicTo(IntPtr stroker, ref FT_Vector control1, ref FT_Vector control2,
            ref FT_Vector to);

        public static __FT_Stroker_CubicTo FT_Stroker_CubicTo =
            FTL.LoadFunction<__FT_Stroker_CubicTo>("FT_Stroker_CubicTo");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_GetBorderCounts(IntPtr stroker, FT_StrokerBorder border,
            out uint anum_points, out uint anum_contours);

        public static __FT_Stroker_GetBorderCounts FT_Stroker_GetBorderCounts =
            FTL.LoadFunction<__FT_Stroker_GetBorderCounts>("FT_Stroker_GetBorderCounts");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Stroker_ExportBorder(IntPtr stroker, FT_StrokerBorder border, IntPtr outline);

        public static __FT_Stroker_ExportBorder FT_Stroker_ExportBorder =
            FTL.LoadFunction<__FT_Stroker_ExportBorder>("FT_Stroker_ExportBorder");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Stroker_GetCounts(IntPtr stroker, out uint anum_points, out uint anum_contours);

        public static __FT_Stroker_GetCounts FT_Stroker_GetCounts =
            FTL.LoadFunction<__FT_Stroker_GetCounts>("FT_Stroker_GetCounts");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Stroker_Export(IntPtr stroker, IntPtr outline);

        public static __FT_Stroker_Export
            FT_Stroker_Export = FTL.LoadFunction<__FT_Stroker_Export>("FT_Stroker_Export");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Glyph_Stroke(ref IntPtr pglyph, IntPtr stoker,
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Glyph_StrokeBorder(ref IntPtr pglyph, IntPtr stoker,
            [MarshalAs(UnmanagedType.U1)] bool inside, [MarshalAs(UnmanagedType.U1)] bool destroy);

        public static __FT_Glyph_StrokeBorder FT_Glyph_StrokeBorder =
            FTL.LoadFunction<__FT_Glyph_StrokeBorder>("FT_Glyph_StrokeBorder");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
            ThrowOnUnmappableChar = true)]
        public delegate FT_Error __FT_Property_Set(IntPtr library, string module_name, string property_name,
            IntPtr value);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false,
            ThrowOnUnmappableChar = true)]
        public delegate FT_Error __FT_Property_Get(IntPtr library, string module_name, string property_name,
            IntPtr value);
        ...
        public static __FT_Reference_Library FT_Reference_Library =
            FTL.LoadFunction<__FT_Reference_Library>("FT_Reference_Library");
        ...
        public static __FT_Set_Debug_Hook
            FT_Set_Debug_Hook = FTL.LoadFunction<__FT_Set_Debug_Hook>("FT_Set_Debug_Hook");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __FT_Add_Default_Modules(IntPtr library);

        public static __FT_Add_Default_Modules FT_Add_Default_Modules =
            FTL.LoadFunction<__FT_Add_Default_Modules>("FT_Add_Default_Modules");
        ...
        public static __FT_Stream_OpenGzip FT_Stream_OpenGzip =
            FTL.LoadFunction<__FT_Stream_OpenGzip>("FT_Stream_OpenGzip");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Gzip_Uncompress(IntPtr memory, IntPtr output, ref IntPtr output_len, IntPtr input,
            IntPtr input_len);

        public static __FT_Gzip_Uncompress FT_Gzip_Uncompress =
            FTL.LoadFunction<__FT_Gzip_Uncompress>("FT_Gzip_Uncompress");
        ...
        public static __FT_Stream_OpenLZW
            FT_Stream_OpenLZW = FTL.LoadFunction<__FT_Stream_OpenLZW>("FT_Stream_OpenLZW");
        ...
        public static __FT_Stream_OpenBzip2 FT_Stream_OpenBzip2 =
            FTL.LoadFunction<__FT_Stream_OpenBzip2>("FT_Stream_OpenBzip2");
        ...
        public static __FT_Library_SetLcdFilter FT_Library_SetLcdFilter =
            FTL.LoadFunction<__FT_Library_SetLcdFilter>("FT_Library_SetLcdFilter");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_Library_SetLcdFilterWeights(IntPtr library, byte[] weights);

        public static __FT_Library_SetLcdFilterWeights FT_Library_SetLcdFilterWeights =
            FTL.LoadFunction<__FT_Library_SetLcdFilterWeights>("FT_Library_SetLcdFilterWeights");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_Manager_New(IntPtr library, uint max_faces, uint max_sizes, ulong maxBytes,
            FTC_Face_Requester requester, IntPtr req_data, out IntPtr amanager);
        ...
        public static __FTC_Manager_Reset
            FTC_Manager_Reset = FTL.LoadFunction<__FTC_Manager_Reset>("FTC_Manager_Reset");
        ...
        public static __FTC_Manager_LookupFace FTC_Manager_LookupFace =
            FTL.LoadFunction<__FTC_Manager_LookupFace>("FTC_Manager_LookupFace");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_Manager_LookupSize(IntPtr manager, IntPtr scaler, out IntPtr asize);

        public static __FTC_Manager_LookupSize FTC_Manager_LookupSize =
            FTL.LoadFunction<__FTC_Manager_LookupSize>("FTC_Manager_LookupSize");
        ...
        public static __FTC_Manager_RemoveFaceID FTC_Manager_RemoveFaceID =
            FTL.LoadFunction<__FTC_Manager_RemoveFaceID>("FTC_Manager_RemoveFaceID");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_CMapCache_New(IntPtr manager, out IntPtr acache);

        public static __FTC_CMapCache_New
            FTC_CMapCache_New = FTL.LoadFunction<__FTC_CMapCache_New>("FTC_CMapCache_New");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate uint __FTC_CMapCache_Lookup(IntPtr cache, IntPtr face_id, int cmap_index, uint char_code);

        public static __FTC_CMapCache_Lookup FTC_CMapCache_Lookup =
            FTL.LoadFunction<__FTC_CMapCache_Lookup>("FTC_CMapCache_Lookup");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_ImageCache_New(IntPtr manager, out IntPtr acache);

        public static __FTC_ImageCache_New FTC_ImageCache_New =
            FTL.LoadFunction<__FTC_ImageCache_New>("FTC_ImageCache_New");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_ImageCache_Lookup(IntPtr cache, IntPtr type, uint gindex, out IntPtr aglyph,
            out IntPtr anode);

        public static __FTC_ImageCache_Lookup FTC_ImageCache_Lookup =
            FTL.LoadFunction<__FTC_ImageCache_Lookup>("FTC_ImageCache_Lookup");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_ImageCache_LookupScaler(IntPtr cache, IntPtr scaler, uint load_flags,
            uint gindex, out IntPtr aglyph, out IntPtr anode);

        public static __FTC_ImageCache_LookupScaler FTC_ImageCache_LookupScaler =
            FTL.LoadFunction<__FTC_ImageCache_LookupScaler>("FTC_ImageCache_LookupScaler");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_SBitCache_New(IntPtr manager, out IntPtr acache);

        public static __FTC_SBitCache_New
            FTC_SBitCache_New = FTL.LoadFunction<__FTC_SBitCache_New>("FTC_SBitCache_New");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_SBitCache_Lookup(IntPtr cache, IntPtr type, uint gindex, out IntPtr sbit,
            out IntPtr anode);

        public static __FTC_SBitCache_Lookup FTC_SBitCache_Lookup =
            FTL.LoadFunction<__FTC_SBitCache_Lookup>("FTC_SBitCache_Lookup");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FTC_SBitCache_LookupScaler(IntPtr cache, IntPtr scaler, uint load_flags, uint gindex,
            out IntPtr sbit, out IntPtr anode);

        public static __FTC_SBitCache_LookupScaler FTC_SBitCache_LookupScaler =
            FTL.LoadFunction<__FTC_SBitCache_LookupScaler>("FTC_SBitCache_LookupScaler");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_OpenType_Validate(IntPtr face, uint validation_flags, out IntPtr base_table,
            out IntPtr gdef_table, out IntPtr gpos_table, out IntPtr gsub_table, out IntPtr jsft_table);

        public static __FT_OpenType_Validate FT_OpenType_Validate =
            FTL.LoadFunction<__FT_OpenType_Validate>("FT_OpenType_Validate");
        ...
        public static __FT_Get_TrueType_Engine_Type FT_Get_TrueType_Engine_Type =
            FTL.LoadFunction<__FT_Get_TrueType_Engine_Type>("FT_Get_TrueType_Engine_Type");
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_TrueTypeGX_Validate(IntPtr face, uint validation_flags, ref byte[] tables,
            uint tableLength);

        public static __FT_TrueTypeGX_Validate FT_TrueTypeGX_Validate =
            FTL.LoadFunction<__FT_TrueTypeGX_Validate>("FT_TrueTypeGX_Validate");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_TrueTypeGX_Free(IntPtr face, IntPtr table);

        public static __FT_TrueTypeGX_Free FT_TrueTypeGX_Free =
            FTL.LoadFunction<__FT_TrueTypeGX_Free>("FT_TrueTypeGX_Free");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_ClassicKern_Validate(IntPtr face, uint validation_flags, out IntPtr ckern_table);

        public static __FT_ClassicKern_Validate FT_ClassicKern_Validate =
            FTL.LoadFunction<__FT_ClassicKern_Validate>("FT_ClassicKern_Validate");

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate FT_Error __FT_ClassicKern_Free(IntPtr face, IntPtr table);

        public static __FT_ClassicKern_Free FT_ClassicKern_Free =
            FTL.LoadFunction<__FT_ClassicKern_Free>("FT_ClassicKern_Free");
