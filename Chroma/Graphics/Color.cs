...
namespace Chroma.Graphics
{
    public struct Color : IEquatable<Color>
    {
        ...
        public static readonly Color Aquamarine = new Color(127, 255, 255);
        ...
        public static readonly Color DarkGolderod = new Color(184, 134, 11);
        ...
        public static readonly Color LightSkyBlue = new Color(136, 206, 250);
        ...
        public static readonly Color RoyalBlue = new Color(65, 105, 255);
